...
namespace Cast{
    ...
    void Cube::Load(){
        ...
        //front plane
        this->m_vertices.push_back({{center.x - offset, center.y - offset, center.z + offset, 1.0}, m_color, {0, 0, 1.0f, 1.0f}});
        this->m_vertices.push_back({{center.x + offset, center.y - offset, center.z + offset, 1.0}, m_color, {0, 0, 1.0f, 1.0f}});
        this->m_vertices.push_back({{center.x + offset, center.y + offset, center.z + offset, 1.0}, m_color, {0, 0, 1.0f, 1.0f}});
        this->m_vertices.push_back({{center.x + offset, center.y + offset, center.z + offset, 1.0}, m_color, {0, 0, 1.0f, 1.0f}});
        this->m_vertices.push_back({{center.x - offset, center.y + offset, center.z + offset, 1.0}, m_color, {0, 0, 1.0f, 1.0f}});
        ...
        //left plane
        this->m_vertices.push_back({{center.x - offset, center.y + offset, center.z + offset, 1.0}, m_color, {-1.0f, 0, 0, 1.0f}});
        this->m_vertices.push_back({{center.x - offset, center.y - offset, center.z + offset, 1.0}, m_color, {-1.0f, 0, 0, 1.0f}});
        this->m_vertices.push_back({{center.x - offset, center.y - offset, center.z - offset, 1.0}, m_color, {-1.0f, 0, 0, 1.0f}});
        this->m_vertices.push_back({{center.x - offset, center.y - offset, center.z - offset, 1.0}, m_color, {-1.0f, 0, 0, 1.0f}});
        this->m_vertices.push_back({{center.x - offset, center.y + offset, center.z - offset, 1.0}, m_color, {-1.0f, 0, 0, 1.0f}});
        ...
        //top plane
        this->m_vertices.push_back({{center.x - offset, center.y + offset, center.z - offset, 1.0}, m_color, {0, 1.0f, 0, 1.0f}});
        this->m_vertices.push_back({{center.x + offset, center.y + offset, center.z - offset, 1.0}, m_color, {0, 1.0f, 0, 1.0f}});
        this->m_vertices.push_back({{center.x + offset, center.y + offset, center.z + offset, 1.0}, m_color, {0, 1.0f, 0, 1.0f}});
        this->m_vertices.push_back({{center.x + offset, center.y + offset, center.z + offset, 1.0}, m_color, {0, 1.0f, 0, 1.0f}});
        this->m_vertices.push_back({{center.x - offset, center.y + offset, center.z + offset, 1.0}, m_color, {0, 1.0f, 0, 1.0f}});
